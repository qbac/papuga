...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "piper_add_voice": "Add own voice…",
        "piper_open_folder": "Open voices folder",
        "custom_added": "Voice added: {name}",
        "custom_no_json": "The voice needs two files: the .onnx model and {name} next to it.",
        "custom_bad_json": "The voice configuration (.onnx.json) could not be read ({name}).",
        "custom_bad_lang": "The language of this voice ('{name}') is not in the language list.",
    ...
    "pl": {
        ...
        "piper_add_voice": "Dodaj własny głos…",
        "piper_open_folder": "Otwórz folder z głosami",
        "custom_added": "Dodano głos: {name}",
        "custom_no_json": "Głos wymaga dwóch plików: modelu .onnx oraz {name} obok niego.",
        "custom_bad_json": "Nie udało się odczytać konfiguracji głosu (.onnx.json): {name}.",
        "custom_bad_lang": "Język tego głosu ('{name}') nie występuje na liście języków.",
